...
| Package | Use it for |
| --- | --- |
| `@doodle-ds/tokens` | DTCG design tokens compiled to CSS custom properties |
| `@doodle-ds/icons` | Hand-drawn React icons with a consistent 24px grid |
| `@doodle-ds/ui` | React 19 components and the Tailwind CSS v4 theme |
| `@doodle-ds/docs` | The local showcase app (private; not published) |
...
`@doodle-ds/ui` has peer dependencies on `react`, `react-dom`, and Tailwind CSS 4. Install the peers when they are not already in your app.
...
@import "tailwindcss";
@import "@doodle-ds/tokens/css/tokens.css";
@import "@doodle-ds/ui/theme.css";
@source "../node_modules/@doodle-ds/ui/dist";
```
...
import { Button, Card, CardContent } from "@doodle-ds/ui";
...
2. Review the JSON change in Git, then run `npm run build` to regenerate `@doodle-ds/tokens` CSS and the docs preview.
...
```sh
npm install @doodle-ds/tokens@latest @doodle-ds/icons@latest @doodle-ds/ui@latest
```
...
```sh
npm run verify
npm pack --dry-run --workspace @doodle-ds/tokens
npm pack --dry-run --workspace @doodle-ds/icons
npm pack --dry-run --workspace @doodle-ds/ui

npm publish --workspace @doodle-ds/tokens --access public
npm publish --workspace @doodle-ds/icons --access public
npm publish --workspace @doodle-ds/ui --access public
```
